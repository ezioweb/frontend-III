import { GamesGrade } from "../../components/GamesGrade";
import { GamesLista } from "../../components/GamesLista";
import './style.scss'

export function VaporGames() {
  const newGames = [
    {
      name: "Hollow Knight",
      plataforms: ["windows"],
    ...
    },
    {
      ...
      price: "30,00",
      picture:
        "https://cdn.akamai.steamstatic.com/steam/apps/219740/header.jpg",
    },
    {
      ...
      price: "45,00",
      picture:
        "https://cdn.akamai.steamstatic.com/steam/apps/1313140/header.jpg",
    },
  ];
  ...
  return (
    <div className="game-lista-component">
      <section className="main-games-section">
        <h1 className="main-title">New Games</h1>
        {
          <ul className="lista-jogos">
            {newGames.map((component, index) => {
              return <GamesLista key={index} item={component} />;
            })}
          </ul>
        }
      </section>
        ...
        <h1 className="main-title">Halloween Games</h1>
        {
          <ul className="lista-jogos">
            {halloweenGames.map((component, index) => {
              return <GamesGrade key={index} item={component} />;
            })}
          </ul>
        }
      </section>
      <section className="main-games-section">
        <h1 className="main-title">Early Acess Games</h1>
        {
          <ul className="lista-jogos">
